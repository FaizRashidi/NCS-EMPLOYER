 ...
 * @author faizr
 */
public class LetterProcessButton extends DataListActionDefault {

    @Override
    public String getName() {
        return "HRDC - EMPM - Letter Process Datalist Action"; 
    }
    ...
    public String getPropertyOptions() {
        String json = "[{\n"
                ...
                + "        name : 'label',\n"
                + "        type : 'textfield',\n"
                + "        description : 'Process Letter button',\n"
                + "        value : 'Process Letter button'\n"
                + "    },{"
                + "        name: 'send_type',"
                + "        label: 'Send Type',"
                + "        type: 'radio',"
...
//        }
        ...
        /*
        LOOP THRU PE DATA - build letter content
        */
        for (HashMap<String, String> pe: pe_list){            
...
//            String emp_email = pe.get("c_empl_email_pri");
            ...
            CommonUtils.saveUpdateForm2(Constants.APP_ID.EMPM, 
                                        ...
                                        mailId, mail_preview_hm);
            /*
            TODO - compile PE data into excel file
            Write letter to word/pdf file
            */
        }
        
        /*
        put written file into compressed folder
        email to vendor
        */
        
//        CommonUtils.sendEmail("VENDOR EMAIL", "VENDOR NAME", "SUBJECT", 
//                "CONTENT", null, "UPLOAD");
    }
}