<div class="form-cell" ${elementMetaData!}>
    <#if !(request.getAttribute("coms.tms.hrdc.element.FileUploadVideoPreview")??)  >
        <link rel="stylesheet" href="${request.contextPath}/plugin/com.tms.hrdc.element.FileUploadVideoPreview/js/modifiedDropzone.css" />
        <script type="text/javascript" src="${request.contextPath}/plugin/com.tms.hrdc.element.FileUploadVideoPreview/js/modifiedDropzone.js"></script>
        <script src="${request.contextPath}/plugin/com.tms.hrdc.element.FileUploadVideoPreview/js/jquery.fileuploadVideoPreview.js"></script>
